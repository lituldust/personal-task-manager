...
interface TaskFormProps {
  onAddTask: (task: string, deadline?: string, status?: string, tags?: string[]) => void;
}
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 w-3/5">
          <div className="flex flex-wrap gap-2">
            <Tag tagName="Tugas" selectTag={selectTag} isSelected={selectedTags.includes("Tugas")}/>
            <Tag tagName="Belajar" selectTag={selectTag} isSelected={selectedTags.includes("Belajar")}/>
            <Tag tagName="Lain-lain" selectTag={selectTag} isSelected={selectedTags.includes("Lain-lain")}/>
          </div>
